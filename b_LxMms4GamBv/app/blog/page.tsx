...
export const metadata: Metadata = {
  title: 'Blog - Mohamed Elhadad',
  description: 'Articles about AI deployment, DevOps pipelines, deepfake detection, and production workflows.',
}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 space-y-6 animate-[slideInUp_0.6s_ease-out]">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl">
            In-depth guides on AI model deployment, CI/CD pipelines, deepfake detection, and DevOps workflows. 
            Learn how to build and ship production-ready systems.
          </p>
        </div>
        ...
        <div className="space-y-8">
          {blogs.map((blog, idx) => (
            <article
              key={blog.slug}
              className="group overflow-hidden rounded-lg border border-border bg-card hover:border-primary hover:shadow-lg transition-all duration-300"
            >
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6 md:p-8">
                {/* Image */}
                <div className="md:col-span-1 h-48 md:h-auto relative overflow-hidden rounded-lg flex-shrink-0">
                  <Image
                    src={blog.image}
                    alt={blog.title}
                    fill
                ...
                <div className="md:col-span-2 flex flex-col justify-between">
                  ...
                  <Link
                    href={`/blog/${blog.slug}`}
                    className="inline-flex items-center gap-2 text-primary font-semibold hover:gap-3 transition-all duration-200 w-fit"
                  >
                    Read Full Article
                    <ArrowRight size={20} />
                  </Link>
